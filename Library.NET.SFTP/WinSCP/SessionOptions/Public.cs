...
{
    private static readonly string _localPath = Path.Combine(@"\\jcfs", "Public");
    private static readonly string _dfsPath = Path.Combine(@"\\crimsonorion.com", "dfs", "Public");
    ...
    public static string MDM_DirectoryPath => Path.Combine(@"\\jcmdm", "Public");
    ...
    public static SessionOptions SessionOptions => new()
    {
        ...
        HostName = "public.crimsonorion.com",
        UserName = "myUsername",
        Password = "myPassword",
